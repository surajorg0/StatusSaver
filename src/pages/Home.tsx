...
import { initializeCache } from '../utils/mediaUtils';
import PageHeader from '../components/PageHeader';

const Home: React.FC = () => {
    const { statuses, loading, error, refetch } = useStatuses('image');
    ...
    return (
        <IonPage>
            <PageHeader title="Images" onRefresh={refetch} loading={loading} />
